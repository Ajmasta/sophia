...
const AboutUs = () => {
    ...
    return(
        ...
        <Link href="contact"><Button className={styles.submitButton}> Commencez un projet </Button></Link>
        <Link href="contact"><Button  className={styles.submitButton}> Nos Projets</Button></Link>


        <Link href="contact"><Button className={styles.submitButton}> Posez vos questions</Button></Link>
